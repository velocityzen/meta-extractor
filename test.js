...
test.cb("host resource with callback syntax", (t) => {
...
test("page resource and promise syntax", (t) =>
...
test("the media resource", async (t) => {
  const res = await extract({
    uri:
...
test("the url with redirects", async (t) => {
  const res = await extract({
    uri:
